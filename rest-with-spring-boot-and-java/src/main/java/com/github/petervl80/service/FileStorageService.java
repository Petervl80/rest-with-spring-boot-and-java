...
import com.github.petervl80.config.FileStorageConfig;
import com.github.petervl80.exception.FileNotFoundException;
        ...
        try {
            if (fileName.contains("..")) {
                ...
                throw new FileStorageException(
                        "Sorry! Filename Contains an invalid path Sequence " + fileName
                );
            }
